  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-[#07A64F]/5 flex">
      ...
      <div className="flex-1 flex flex-col">
        {/* Enhanced Header */}
        <div className="bg-gradient-to-r from-white via-[#07A64F]/5 to-[#1295D0]/5 shadow-lg border-b border-[#1295D0]/20 px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <div className="border-l border-[#1295D0]/30 pl-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Button 
                ...
                className="border-[#07A64F]/30 text-[#07A64F] hover:bg-[#07A64F]/10 hover:border-[#07A64F]/50"
              >
                💰 Record Payment
              </Button>
          ...
          <div className="mt-3 flex items-center space-x-2 text-sm">
            <span className="text-[#231F20]/60">Admin Panel</span>
