...
- [ ] 2. Create TypeORM entities and database schema
  ...
  - [ ] 2.3 Create normalized relationship entities
...
- [ ] 5. Implement NestJS service layer with TypeORM repositories
  - [ ] 5.1 Create StudentService with TypeORM repository
  ...
  - [ ] 5.2 Create RoomService with complex relationship handling
...
- [ ] 6. Create NestJS controllers with API compatibility
  ...
  - [ ] 6.4 Create BookingController and DiscountController
...
- [ ] 7. Create DTOs and validation classes
  ...
  - [ ] 7.2 Create Room and financial DTOs
...
- [ ] 8. Create TypeORM migration system
  - [ ] 8.1 Generate TypeORM migrations from entities
